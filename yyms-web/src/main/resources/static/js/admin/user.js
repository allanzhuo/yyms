layui.use(['form', 'table', 'layer', 'tree'], function () {
    ...
    table.render({
        ...
        , cols: [[
            ...
            , {field: 'email', width: '40%', title: '邮箱', align: 'center'}
            , {field: 'roleName', width: '40%', title: '角色', align: 'center'}
    ...
    form.on('switch(status)', function (obj) {
        $.post("/admin/role/edit/status", {id: this.value, status: obj.elem.checked}, function (res) {
            if (res.code == 200) {
